  ...
  return (
    <main className="flex flex-col gap-8" id="main">
      ...
      <section className="flex flex-col gap-4">
        ...
        <p>
          During my time as a project manager in marketing and digital agencies,
          I managed campaigns, coordinated IT projects, and built landing pages.
          Gradually, I took on more and more technical responsibilities – from
          concept to implementation.
        </p>
        <p>
          What really shaped my career was seeing UX issues that couldn't be
          fixed anymore once projects reached a certain stage. That motivated me
          to move deeper into development, so I could design products from the
          ground up that work technically and deliver great user experiences.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2">
              <li className="ml-4 list-disc pl-2">
                Key player in the global relaunch of 14 e-commerce brands across
                30 countries
              </li>
              <li className="ml-4 list-disc pl-2">
                Transformed a monolithic architecture into modern microservices
                using React & Next.js
              </li>
              <li className="ml-4 list-disc pl-2">
              ...
              <li className="ml-4 list-disc pl-2">
                Made strategic technology decisions with a focus on performance,
