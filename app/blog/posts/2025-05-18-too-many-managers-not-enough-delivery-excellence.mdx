...
By driving everyone towards the macro level, we are not fostering innovation. We don't need more ideas, we need more ideas that are executed with excellence.
